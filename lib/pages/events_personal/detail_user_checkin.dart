                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: listuserscheckin
                                          .map((ListUserCheckins item) => Card(
                                                  child: ListTile(
                                                leading: Padding(
                                                  padding:
                                ...
                                Padding(
                                  ...
                                  child: CircularPercentIndicator(
                                    ...
                                    percent:int.parse(
                                        ...
                                        int.parse(jumlahcheckinX.toString()),
                                    center: Text(
                                      percentX,
                                      style: new TextStyle(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Padding(
                                          padding:
                                              const EdgeInsets.only(left: 5.0),
                                          child: Text(
                                              jumlahtidakhadirX + ' Belum Checkin'),
                                        ),
                                      ],
                                    ))
                              ],
