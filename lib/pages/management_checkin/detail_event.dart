...
class DetailEventNow extends StatefulWidget {
  DetailEventNow({Key key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return DetailEventNowWidget();
  }
}

class DetailEventNowWidget extends State<DetailEventNow> {
  @override
                        ...
                        child: RaisedButton(
                          ...
                          onPressed: () async {
                            Fluttertoast.showToast(
                                msg: "Anda Berhasil Daftar Event");
                            Navigator.push(context,MaterialPageRoute(builder: (context) => DashboardCheckin() ));
                          },
                          child: Text(
                            "Chcekin",
