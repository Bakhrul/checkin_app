                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return Container(
                              ...
                              child: ButtonTheme(
                                ...
                                height: 0,
                                child: RaisedButton(
                                  color: listkategoriEvent[index].color == true ?Color.fromRGBO(41, 30, 47, 1) : Colors.white,
                                  elevation: 0.0,
                                  highlightColor: Colors.transparent,
                                  highlightElevation: 0.0,
                                  onPressed: () {
                                    if(listkategoriEvent[index].color == true){
                                        setState(() {
                                          filterX = 'all';
                                          ListKategoriEvent(
                                            color: false,
                                  ...
                                  padding: EdgeInsets.only(
                                      ...
                                      bottom: 7.0),
                                  child: Text(
                                    listkategoriEvent[index].nama == null ? 'Unknown Kategori' : listkategoriEvent[index].nama,
                                    style: TextStyle(
                                        color: listkategoriEvent[index].color == true ? Colors.white : Color.fromRGBO(41, 30, 47, 1),
                                        fontWeight: FontWeight.w500),
                                  ),
                                  shape: RoundedRectangleBorder(
                                      ...
                                      side: BorderSide(
                                        color: listkategoriEvent[index].color == true ?  Color.fromRGBO(41, 30, 47, 1) : Color.fromRGBO(41, 30, 47, 1),
                                      )),
                                ),
                              ));
                        },
                                                              ...
                                                              padding:
                                                                  const EdgeInsets
                                                                      ...
                                                                      top:
                                                                          10.0),
                                                              child: Text(
                                                                listItemFollowing[index].alamat == null ?'Lokasi Event Tidak Diketahui' : listItemFollowing[index].alamat,
                                                                style: TextStyle(
                                                                    color: Colors
                                                                        .grey),
                                                              ),
