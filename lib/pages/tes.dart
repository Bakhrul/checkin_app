...
// void main() => runApp(new CobaApps());

class CobaApps extends StatefulWidget {
  @override
  _CobaAppsState createState() => new _CobaAppsState();
}

class _CobaAppsState extends State<CobaApps> {
  ...
  Future<void> initPlatformState() async {
    ...
    await OneSignal.shared
        .init("b9507a88-9cdd-4950-9b84-08d1628f3470", iOSSettings: settings);
