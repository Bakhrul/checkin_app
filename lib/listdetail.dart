...
class DetailList extends StatefulWidget {
  DetailList({Key key, this.title, this.type, this.typeCategory}) : super(key: key);
  final type;
  final typeCategory;
  final String title;
  @override
...
class _DetailListState extends State<DetailList> {
  ...
  _getAll(int type,String query) async {
    ...
    try{
      ...
      var _typeCategory = widget.typeCategory;
      final ongoingevent = await http.get(
        url('api/event/getdata/dashboard/detail/$_type/$page/$_typeCategory'),
        headers: requestHeaders,
        // body:body
      );
